...
std::vector<Posicion> Astar::mapear()
{
    ...
    while(!rutaEncontrada)
    {
        ...
        //std::cout << "antes de comprobar: " << mapa->getColisiones(()[0][0] << std::endl;
        vecinos->clear();
        //listaAbierta->clear();
...
std::vector<Posicion> Astar::comprobarVecinos(Posicion padre, Mapa mapa)
{
    ...
    bool **paredes = mapa.getColisiones();
    ...
    std::cout << "pos 0-0: " << mapa.getColisiones(()[0][0] << std::endl;
    std::cout << "pos 0-1: " << mapa.getColisiones(()[0][1] << std::endl;
    std::cout << "pos 1-0: " << mapa.getColisiones(()[1][0] << std::endl;
    std::cout << "pos 8-9: " << mapa.getColisiones(()[mapa.getHeight()-1][mapa.getWidth()-1] << std::endl;
    for(int k = 0; k < 9; k++)
    {
        std::cout << mapa.getColisiones(()[k][0];
    }
    std::cout << std::endl;
    */
    /*
