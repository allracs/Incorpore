...
: State(window, supportedKeys, states)
{
    ...
    texfondo->loadFromFile("fondoMenu.png");


    this->background.setTexture(texfondo);
    //titulo
   /* titulofuente = new sf::Font;
    titulofuente->loadFromFile("never.ttf");
    titulo = new sf::Text;
...
void MainMenuState::initButtons()
{
    ...
    */
     this->buttons["GAME_STATE"] = new Button((1280/2)-150/2,720/2,150,50,
    &this->font, "Jugarrr",
    sf::Color(70,70,70,200), sf::Color(150,150,150,255),sf::Color(20,20,20,200));

    this->buttons["EXIT_STATE"] = new Button((1280/2)-150/2,(720/2)+100,150,50,
    &this->font, "Salir",
...
void MainMenuState::initFonts()
{
    ...
    if(!this->fontTitulo.loadFromFile("manaspc.ttf"))
    {
        throw("ERROR:MAINMENUSTATE:NO SE HA CARGADO LA FUENTE DEL TITULO");
    }
